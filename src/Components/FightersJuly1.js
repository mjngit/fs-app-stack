...
const FightersJuly1 = () => {
    ...
    const fightersJuly1 = fighters.sort((a, b) => {
        return a.id - b.id
    }).filter(fighter => fighter.id > 152 && fighter.id < 175 )
   
    console.log(fightersJuly1)

    let notes = {}
    

    for(let i = 0; i < fightersJuly1.length; i += 2){
        let redCorn = fightersJuly1[i]
        let blueCorn = fightersJuly1[i + 1]
        let redCornTDD
        let blueCornTDD
        let redCornTDA
        let blueCornTDA
  ...
  return (
    <>
     <div style={{display: 'flex', alignItems: 'center', justifyContent: 'center'}}><h1>Fighters Of The Week: July 1</h1></div>
    ...
    <Typography style={{display: 'flex', alignItems: 'center', justifyContent: 'center'}}variant="h2">Main Card</Typography>        
      <h3> Main Event:  {fightersJuly1[0] ? fightersJuly1[0].name + " (" + (fightersJuly1[0].record) + ')'  : ''} vs. {fightersJuly1[1] ? fightersJuly1[1].name + " (" + fightersJuly1[1].record + ')' : ''}</h3>
    <List>
        {notes[77] ? notes[77].map((note, idx) => {
            return (
    ...
    <h3>Fight 2: {fightersJuly1[2] ? fightersJuly1[2].name + " (" + (fightersJuly1[2].record) + ')' : ''} vs. {fightersJuly1[3] ? fightersJuly1[3].name + " (" + (fightersJuly1[3].record) + ')' : ''}</h3>
    <List>
        {notes[78] ? notes[78].map((note, idx) => {
            return (
            <ListItem disablePadding key={idx}>
              <ListItemText primary={note} />
            </ListItem>
    ...
    <h3>Fight 3: {fightersJuly1[4] ? fightersJuly1[4].name + " (" + (fightersJuly1[4].record) + ')' : ''} vs. {fightersJuly1[5] ? fightersJuly1[5].name + " (" + (fightersJuly1[5].record) + ')' : ''}</h3>
    <List>
        {notes[79] ? notes[79].map((note, idx) => {
            return (
            <ListItem disablePadding key={idx}>
              <ListItemText primary={note} />
            </ListItem>
    ...
    <h3>Fight 4: {fightersJuly1[6] ? fightersJuly1[6].name + " (" + (fightersJuly1[6].record) + ')' : ''} vs. {fightersJuly1[7] ? fightersJuly1[7].name + " (" + (fightersJuly1[7].record) + ')' : ''}</h3>
    <List>
        {notes[80] ? notes[80].map((note, idx) => {
            return (
            <ListItem disablePadding key={idx}>
              <ListItemText primary={note} />
            </ListItem>
    ...
    <h3>Fight 5: {fightersJuly1[8] ? fightersJuly1[8].name + " (" + (fightersJuly1[8].record) + ')' : ''} vs. {fightersJuly1[9] ? fightersJuly1[9].name + " (" + (fightersJuly1[9].record) + ')' : ''}</h3>
    <List>
        {notes[81] ? notes[81].map((note, idx) => {
            return (
            <ListItem disablePadding key={idx}>
              <ListItemText primary={note} />
            </ListItem>
    ...
    <h3>Fight 6: {fightersJuly1[10] ? fightersJuly1[10].name + " (" + (fightersJuly1[10].record) + ')' : ''} vs. {fightersJuly1[11] ? fightersJuly1[11].name + " (" + (fightersJuly1[11].record) + ')' : ''}</h3>
    <List>
        {notes[82] ? notes[82].map((note, idx) => {
            return (
            <ListItem disablePadding key={idx}>
              <ListItemText primary={note} />
            </ListItem>
    ...
    <h3>Fight 7: {fightersJuly1[12] ? fightersJuly1[12].name + " (" + (fightersJuly1[12].record) + ')' : ''} vs. {fightersJuly1[13] ? fightersJuly1[13].name + " (" + (fightersJuly1[13].record) + ')' : ''}</h3>
    <List>
        {notes[83] ? notes[83].map((note, idx) => {
            return (
            <ListItem disablePadding key={idx}>
              <ListItemText primary={note} />
            </ListItem>
    ...
    <h3>Fight 8: {fightersJuly1[14] ? fightersJuly1[14].name + " (" + (fightersJuly1[14].record) + ')' : ''} vs. {fightersJuly1[15] ? fightersJuly1[15].name + " (" + (fightersJuly1[15].record) + ')' : ''}</h3>
    <List>
        {notes[84] ? notes[84].map((note, idx) => {
            return (
            <ListItem disablePadding key={idx}>
              <ListItemText primary={note} />
            </ListItem>
    ...
    <h3>Fight 9: {fightersJuly1[16] ? fightersJuly1[16].name + " (" + (fightersJuly1[16].record) + ')' : ''} vs. {fightersJuly1[17] ? fightersJuly1[17].name + " (" + (fightersJuly1[17].record) + ')' : ''}</h3>
    <List>
        {notes[85] ? notes[85].map((note, idx) => {
            return (
            <ListItem disablePadding key={idx}>
              <ListItemText primary={note} />
            </ListItem>
    ...
    <h3>Fight 10: {fightersJuly1[18] ? fightersJuly1[18].name + " (" + (fightersJuly1[18].record) + ')' : ''} vs. {fightersJuly1[19] ? fightersJuly1[19].name + " (" + (fightersJuly1[19].record) + ')' : ''}</h3>
    <List>
        {notes[86] ? notes[86].map((note, idx) => {
            return (
            <ListItem disablePadding key={idx}>
              <ListItemText primary={note} />
            </ListItem>
    ...
    <h3>Fight 11: {fightersJuly1[20] ? fightersJuly1[20].name + " (" + (fightersJuly1[20].record) + ')'  : ''} vs. {fightersJuly1[21] ? fightersJuly1[21].name + " (" + (fightersJuly1[21].record) + ')' : ''}</h3>
    <List>
        {notes[87] ? notes[87].map((note, idx) => {
            return (
            <ListItem disablePadding key={idx}>
              <ListItemText primary={note} />
            </ListItem>
    ...
    <Divider />
{/* 
    <h3>Fight 12: {fightersJuly1[22] ? fightersJuly1[22].name + " (" + (fightersJuly1[22].record) + ')' : ''} vs. {fightersJuly1[23] ? fightersJuly1[23].name + " (" + (fightersJuly1[23].record) + ')' : ''}</h3>
    <List>
    ...
    <h3>Fight 13: {fightersJuly1[24] ? fightersJuly1[24].name + " (" + (fightersJuly1[24].record) + ')' : ''} vs. {fightersJuly1[25] ? fightersJuly1[25].name + " (" + (fightersJuly1[25].record) + ')' : ''}</h3>
    <List>
    ...
    <h3>Fight 14: {fightersJuly1[26] ? fightersJuly1[26].name + " (" + (fightersJuly1[26].record) + ')' : ''} vs. {fightersJuly1[27] ? fightersJuly1[27].name + " (" + (fightersJuly1[27].record) + ')' : ''}</h3>
    <List>
